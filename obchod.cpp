...
int main(){
     ...
     int userInput; //V jake kategorii chce uzivatel nakupovat

     //Promenne pro vyber zbozi v jednotlivych kategoriich
     int zeleninaVyber;
     int napojeVyber;
     int kuponInput;
     int hrySlevaVyber;
     ...
     //Promenne ktere ukazuji, kolik jsme si z her koupili, bez toho, aniz by to vypisovalo s desetinymi cisly
     ...
     switch(userInput){ //Uzivatel zvoli do jake kategorie chce jit
